...
let content = fs.readFileSync('src/app/exercises/[bodyPart]/page.tsx', 'utf8');
...
content = content.replace(
  ...
  const faqs = generateBodyPartFAQs(bodyPart, exercises.length, topExerciseNames);
...
fs.writeFileSync('src/app/exercises/[bodyPart]/page.tsx', content);
console.log('Body part hub page updated with FAQ schema');
