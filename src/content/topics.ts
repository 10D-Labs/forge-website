...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    description: "Build a solid foundation with essential strength training knowledge. From progressive overload to workout splits, learn the fundamentals that drive results.",
    metaDescription: "Essential strength training guides: progressive overload, workout splits, training frequency, and periodization. Science-backed fundamentals for building muscle.",
    keywords: ["strength training", "progressive overload", "workout split", "training fundamentals", "muscle building basics"],
    relatedCategories: ["training-fundamentals", "strength-training"],
  },
  {
