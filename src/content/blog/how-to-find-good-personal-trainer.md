...
Only one thing matters: is the certification accredited by the [National Commission for Certifying Agencies](https://www.credentialingexcellence.org/ncca) (NCCA)?
...
Most certification bodies have public databases. NASM has a [credential verification tool](https://www.nasm.org/resources/validate-credentials). ACE has a [verification page](https://www.acefitness.org/btob/verify-cert-number.aspx). You can also check the [U.S. Registry of Exercise Professionals](https://usreps.org/registry/) which lists over 130,000 certified professionals.
