...
const FeaturesSection = () => {
  return <section id="features" className="py-20 md:py-28 bg-forge-dark">
      <div className="container">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground text-lg">
            Forge combines cutting-edge AI with exercise science to give you an elite personal trainer that's always available.
          </p>
        </div>

        {/* Features Grid */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => <FeatureCard key={feature.title} icon={feature.icon} title={feature.title} description={feature.description} index={index} />)}
        </div>
      </div>
    </section>;
};
