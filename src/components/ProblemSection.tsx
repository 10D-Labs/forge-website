  ...
  return (
    <section className="py-20 md:py-28 bg-background">
      <div className="container">
        <div
          ref={headerRef}
          className={`text-center max-w-2xl mx-auto mb-16 transition-all duration-700 ease-out ${headerVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div
            ref={problemRef}
            className={`p-8 rounded-2xl bg-destructive/5 border border-destructive/20 transition-all duration-700 ease-out ${problemVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
          ...
          <div
            ref={solutionRef}
            className={`p-8 rounded-2xl bg-primary/5 border border-primary/20 transition-all duration-700 ease-out delay-150 ${solutionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            <h3 className="text-xl font-semibold mb-6 flex items-center gap-2">
