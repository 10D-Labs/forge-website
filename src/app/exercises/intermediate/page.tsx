      ...
      <section className="py-4 bg-surface-1 border-y border-border-subtle sticky top-16 z-20">
        <div className="container">
          <div className="flex gap-2">
            ...
            <span
              className="px-4 py-2 text-sm font-barlow-condensed font-semibold uppercase tracking-wide angular-border text-primary"
              style={{ "--angular-bg": "hsl(var(--primary) / 0.2)", "--angular-border-color": "hsl(var(--primary) / 0.4)" } as React.CSSProperties}
            >
