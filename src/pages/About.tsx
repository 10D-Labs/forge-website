...
const About = () => {
  ...
  return <div className="min-h-screen bg-background">
      <SEOHead title="About Forge - Our Mission to Make Fitness Accessible" description="Learn about Forge's mission to make personal training accessible to everyone through AI. Meet the team behind your AI fitness trainer." canonicalPath="/about" keywords="Forge AI founders, fitness accessibility mission, affordable personal training solution, AI fitness startup, democratizing fitness coaching, fitness tech company" />
      ...
      <main className="pt-20" role="main" itemScope itemType="https://schema.org/AboutPage">
        {/* Hero Section */}
        <section className="py-12 md:py-16 bg-hero-gradient relative overflow-hidden" aria-labelledby="about-heading">
        ...
        <section className="py-12 md:py-16 bg-background" aria-labelledby="solution-heading">
          <div className="container">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
                <p>
                  Forge™ was born after Jake, the founder, started working with a personal trainer and saw firsthand just how impactful, and expensive, it was. Realizing that with AI trainers almost everyone could get most of the benefits for less than 5% of the cost, he got to work.
                </p>
                <p>
        ...
        {/* Founders Section */}
        <section className="py-12 md:py-16 bg-forge-dark" aria-labelledby="team-heading" itemScope itemType="https://schema.org/Organization">
          <div className="container">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {founders.map(founder => <article key={founder.name} className="p-8 rounded-2xl card-gradient border border-border/50 text-center" itemScope itemType="https://schema.org/Person" itemProp="employee">
                  <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-4 border-primary/50">
                    <img src={founder.image} alt={`${founder.name} - ${founder.role} at Forge AI Fitness`} className="w-full h-full object-cover" loading="lazy" width="128" height="128" itemProp="image" />
                  </div>
