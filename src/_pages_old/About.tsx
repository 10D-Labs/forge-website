  ...
  const values = [
    {
      icon: Users,
      title: "Accessibility",
      description: "A personal trainer in everyone's pocket, regardless of location or time.",
    },
    {
      icon: Zap,
      title: "Simplicity",
      description: "No confusion, no excuses. Just show up and your trainer handles the rest.",
    },
    {
      icon: TrendingUp,
      title: "Transformation",
      description: "It starts in the gym, but the confidence you build changes everything.",
    },
  ];
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6 text-text-secondary text-lg leading-relaxed font-barlow">
                <p>
                  Jake started working with a personal trainer and everything changed. Better workouts,
                  faster progress, and the confidence that comes from knowing exactly what to do every
                  time he walked into the gym.
                </p>
                <p>
                  The problem? It cost a fortune. Most people can't afford $300-500/month for that kind
                  of guidance. But with AI, almost everyone can get those same benefits for a fraction
                  of the cost.
                </p>
                <p>
                  So we built Forge — an AI trainer that adapts to your personality, creates custom
                  workouts based on your goals and schedule, and keeps you accountable. No more
                  guesswork. No more wasted sessions. Just a trainer in your corner, ready whenever you
                  are.
                </p>
              </div>
            </div>
              ...
              <div className="grid sm:grid-cols-3 gap-8" role="list" aria-label="Company values">
                {values.map((value) => (
                  <article key={value.title} role="listitem">
                    ...
                    <p className="text-text-secondary text-sm font-barlow">{value.description}</p>
                  </article>
                ))}
              </div>
            </div>
