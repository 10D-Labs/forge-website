# Cardio Exercises - Forge

## Quick Answer

36 exercises targeting your cardio. Build strength and muscle with exercises organized by equipment type.

---

## All Cardio Exercises by Equipment
...
- **Jump Rope (Time)** — Beginner | Target: Cardiovascular

### Treadmill (4 exercises)

- **Treadmill Run (Time)** — Beginner | Target: Cardiovascular
- **Walking on Incline Treadmill (Time)** — Beginner | Target: Cardiovascular
- **Treadmill Run (Distance)** — Beginner | Target: Cardiovascular
- **Walking on Incline Treadmill (Distance)** — Beginner | Target: Cardiovascular

---

## Build Your Cardio with Forge
