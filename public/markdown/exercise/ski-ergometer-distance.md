# Ski Ergometer (Distance) - Forge Exercise Library
...
## How to Perform Ski Ergometer (Distance)

1. Stand facing the ski ergometer and grasp the handles.
2. Start in a tall position with arms extended overhead.
3. Pull the handles down powerfully while hinging at the hips.
4. Allow your arms to swing back naturally as you complete the pull.
5. Return to the starting position and repeat in a continuous rhythm.
6. Continue until you reach your target distance.
...
## Master Ski Ergometer (Distance) with Forge

Get personalized coaching, form feedback, and workout plans featuring Ski Ergometer (Distance) and other exercises tailored to your goals.
