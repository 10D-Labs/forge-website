# Elliptical (Time) - Forge Exercise Library

## Quick Answer

The elliptical is a cardiovascular exercise performed on an elliptical machine. It simulates a walking or running motion with low impact on the joints, making it suitable for a wide range of fitness levels. The exercise targets the cardiovascular system while also engaging the quadriceps, hamstrings, glutes, and calves.

**Details:**
- **Body Part:** Cardio
- **Equipment:** Cardio Machine
- **Target Muscle:** Cardiovascular
- **Secondary Muscles:** Quadriceps, Hamstrings, Glutes, Calves
- **Difficulty:** Beginner
- **Category:** Cardio
- **Tracking Type:** time
...
## How to Perform Elliptical (Time)

1. Adjust the resistance level and incline of the elliptical machine to your desired settings.
...
7. Gradually decrease the intensity before stepping off.
...
## Master Elliptical (Time) with Forge

Get personalized coaching, form feedback, and workout plans featuring Elliptical (Time) and other exercises tailored to your goals.
