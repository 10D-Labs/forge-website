...
A [study published in the Journal of Internal Medicine](https://onlinelibrary.wiley.com/doi/full/10.1111/joim.12850) followed steroid users for over seven years. Steroid users had **three times the risk of death** compared to non-users (hazard ratio 3.0, 95% CI 1.3-7.0). A [2024 study in JAMA](https://jamanetwork.com/journals/jama/fullarticle/2816584) found even higher risks, with a 3.64-fold increase in unnatural deaths and 2.24-fold increase in natural deaths.
...
Natural training [improves cardiovascular health during recovery periods](/blog/muscle-growth-during-recovery). Steroids destroy it.

### Liver damage

Liver complications range from elevated enzyme levels to tumors. Oral steroids are particularly harsh because they pass through the liver repeatedly. According to the [NCBI Bookshelf on Androgenic Steroids](https://www.ncbi.nlm.nih.gov/books/NBK548931/), some users develop peliosis hepatis, a condition where blood-filled cysts form in the liver. These can rupture and cause fatal internal bleeding.
...
In the United States, anabolic steroids are [Schedule III controlled substances](https://www.deadiversion.usdoj.gov/schedules/schedules.html) under the Controlled Substances Act. Same legal category as ketamine and certain barbiturates.
...
Research on untrained individuals starting proper strength training shows first-year gains of [15-25 lbs (7-11 kg) of muscle mass](https://www.strongerbyscience.com/realistic-training-goals/) are achievable for men. Women can expect roughly half that, 8-12 lbs in the first year.
...
[Progressive overload](/blog/progressive-overload-explained) means consistently increasing the stimulus you're applying to your muscles. More weight, more reps, more sets, shorter rest periods. The specific method matters less than the consistency of progression. A program from [Forge](https://forgetrainer.ai) tracks this automatically.
...
[Recovery and consistency](/blog/science-of-workout-consistency) beat perfection. [Training four days a week for a year](/blog/best-workout-split-guide) produces better results than training six days a week for two months before burning out. Your body builds muscle during recovery, not during workouts.
...
That's where proper programming matters. Cookie-cutter programs don't account for your individual recovery capacity. [Working with trainers who understand natural progression](/blog/personalized-workout-plans-vs-generic) ensures you're training at the right intensity and volume for your body. [Forge](https://forgetrainer.ai) adapts to how you're recovering, adjusting volume based on your feedback, performance, and [progress tracking](/blog/how-to-track-fitness-progress).
...
[Forge](https://forgetrainer.ai) provides that. AI trainers who understand natural progression. Programs that adapt to your recovery capacity. Guidance based on what works for natural athletes, not what works when you're running a gram of test.
