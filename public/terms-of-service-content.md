...
7. [SOFTWARE AND END USER LICENSE AGREEMENT (EULA)](#7-software-and-end-user-license-agreement-eula)
...
You can cancel your subscription at any time. If you subscribed through the Apple App Store, you must cancel through your Apple ID account settings. If you subscribed through Google Play Store, you must cancel through your Google Play account settings. The App provides a "Manage Subscription" button that will direct you to the appropriate app store subscription management page. Please note that deleting the App or contacting us directly will not automatically cancel your subscription with Apple or Google. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at support@forgetrainer.ai.
...
FOR CALIFORNIA RESIDENTS: Your subscription will automatically renew at the then-current subscription rate unless you cancel at least 24 hours before the end of the current billing period. You may cancel your subscription at any time by accessing the "Manage Subscription" feature in the App, which will direct you to your device's app store subscription management. Upon cancellation, you will continue to have access to premium features until the end of your current billing period. By subscribing, you acknowledge that your subscription has an initial and recurring payment feature and you accept responsibility for all recurring charges prior to cancellation.

## 7. SOFTWARE AND END USER LICENSE AGREEMENT (EULA)

### License Grant

Subject to your compliance with these Legal Terms, we grant you a limited, non-exclusive, non-transferable, non-sublicensable, revocable license to download, install, and use the software application ("App") on a device that you own or control, solely for your personal, non-commercial use.

### Ownership

The App, including all content, features, and functionality, is owned by 10D Labs, LLC and is protected by copyright, trademark, and other intellectual property laws. This license does not grant you any ownership interest in the App, but only a limited right to use the App in accordance with these Legal Terms.
...
- Use the App to provide services to third parties or operate a competing business
- Use the App in any way that violates applicable laws or regulations

For clarity, creating and sharing personal content that features the App (such as reviews, tutorials, or social media posts) is permitted, even if such content is monetized through advertising or creator programs.

### Updates and Modifications

We may from time to time develop and provide updates to the App, which may include bug fixes, patches, new features, or new versions. Updates may be automatically installed without providing any additional notice or obtaining your consent. You consent to such automatic updates and agree that these Legal Terms will apply to all such updates.

### Termination of License

This license is effective until terminated. Your rights under this license will terminate automatically without notice if you fail to comply with any of these Legal Terms. Upon termination, you must cease all use of the App and delete all copies from your device.
...
- Publish false or defamatory statements about us or the Services.
...
In no event shall any Dispute brought by either Party related in any way to the Services be commenced more than one (1) year after the cause of action arose, or such longer period as required by applicable law. If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.

### Opt-Out Right

You may opt out of this arbitration agreement by sending written notice of your decision to opt out to support@forgetrainer.ai within thirty (30) days of first accepting these Legal Terms. Your notice must include your name, mailing address, email address associated with your account, and a clear statement that you wish to opt out of the arbitration provision. If you opt out of the arbitration provision, all other parts of these Legal Terms will continue to apply to you, and we will not retaliate against you for opting out.
