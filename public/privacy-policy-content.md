...
- Voice recordings (when using speech-to-text to communicate with your AI trainer)
...
*In Short: Some information — such as your device information and usage data — is collected automatically when you use our Services.*
...
- Device identifiers (such as your device ID, advertising identifier, and app instance ID)
- Device information (such as device type, operating system, and version)
- Usage data (such as features used, actions taken, and time spent in the app)
- Crash and error logs (technical information collected when the app experiences errors)
...
**Third-Party Service Providers.** We may share your information with the following third-party service providers to perform services on our behalf:
- Analytics providers (such as Firebase/Google Analytics) to help us understand how our Services are used
- Payment processors to process your subscription payments
- Push notification services to send you notifications about your workouts and account
- Cloud hosting providers to store and process your data securely
- Speech-to-text services to convert your voice messages into text when communicating with your AI trainer
...
- Log in to your account settings and update or delete your account
...
| L. Sensitive personal Information | Health-related information including injuries, physical limitations, body measurements, and fitness data | YES |
...
We have not sold personal information to third parties for monetary consideration in the preceding twelve (12) months. We share limited information with service providers (such as cloud hosting and payment processors) solely to operate our Services, as described in the section "[WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?](#4-when-and-with-whom-do-we-share-your-personal-information)"
